...
<link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css'>
  ...
  <body translate="no">  
    ...
    <div class="templatemo-flex-row">
      ...
      <div class="search">
        <input type="text" placeholder="Поиск соискателя" />
...
<div class="chat-with">Чат ${candidate}</div>
<div class="chat-num-messages">всего X сообщений</div>
</c:if>
  <c:if test = "${candidate == null}">
    <div class="chat-with">Чат с соискателями</div>
    <div class="chat-num-messages">всего X сообщений</div>
  </c:if>
</div>
