      ...
      <div>
        <div id="calendar">
              ...
              <div className="madeBy">
                <div className="madeOverlay">
                  ...
                  <span id="madeWeb">
                    <a
                      target="_blank"
                      href="https://codepen.io/RicardoBarbosa/"
                    >
                ...
                <img
                  src="https://imgur.com/LOaisfQ.jpg"
                  width="260"
                  height="200"
                />
              </div>
          ...
          <div id="header">
            ...
            ></i>
            <p>
              {this.state.dates.nameofmonth} {this.state.dates.year}
            </p>
            <div>
              <i
                ...
                aria-hidden="true"
              >
                <span>{this.state.present.getDate()}</span>
              </i>
            </div>
            ...
            <div className="entry_details">
              <div>
                <div className="entry_info first">
                  ...
                  />
                  <label htmlFor="entry-img" id="for_img">
                    <span id="file_name">Choose an image</span>
                  </label>
                ...
                <div className="entry_info2 first second duration">
                  ...
                  <div id="not-all-day">
                    ...
                    <p id="hour">
                      <input type="number" id="enter_hour" min="0" max="24" /> h
                    </p>
                  </div>
                </div>
          ...
          {this.state.openEntry ? (
            <div id="open_entry">
              <div
                className="entry_img"
                style={{
                  backgroundColor: this.state.openEntry.entryColor.color
                }}
              >
                    ...
                    <p>
                      ...
                      <span id="entry_times">
                        ...
                        {this.state.openEntry.entryDuration === "All day"
                          ? "| All day"
                          : "at " + this.state.openEntry.entryDuration + ":00"}
                      </span>
                    </p>
                  </div>
                </div>
              ...
              <div className="entry openedEntry">
                <div>
                  <i className="fa fa-map-marker" aria-hidden="true"></i>{" "}
              ...
              <div className="entry openedEntry noteDiv">
                <div>
                  <i className="fa fa-pencil" aria-hidden="true"></i>{" "}
                  {this.state.openEntry.entryNote ? (
                    <span id="note">{this.state.openEntry.entryNote}</span>
                  ) : (
          ...
          <div id="entries">
            <div className="contain_entries">
              <div id="entries-header">
                ...
                this.state.present.getFullYear() === this.state.currYear ? (
                  <p className="currday">TODAY</p>
                ) : null}
              </div>
              {this.state.entries != "" ? (
                <div>
                          ...
                          <div className="entry" id={e} key={e}>
                            <div style={style}>
                              <div
                                ...
                                onClick={this.openEntry.bind(null, entry, e)}
                              >
